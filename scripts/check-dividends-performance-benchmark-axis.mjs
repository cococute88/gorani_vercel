...
assert.doesNotMatch(account, /sp500\?\.latestValue \?\? 0|schd\?\.latestValue \?\? 0|latestValue: series\.latestValue \?\? 0/);
assert.doesNotMatch(total, /schdValueKRW \?\? 0|sp500ValueKRW \?\? 0/);
...
assert.match(total, /deposit: null, portfolio: null, schd: null, sp500: null, monthlyProfit: null/);
