...
export default function PortfolioSelectorMock({ onManage }: Props) {
  return (
    <div className="rounded-2xl border border-[#2a3336] bg-[#191f20] p-4">
      ...
      <div className="mt-2 flex items-center justify-between gap-3">
        ...
        <button
          type="button"
          onClick={onManage}
          className="min-w-fit shrink-0 whitespace-nowrap rounded-lg border border-blue-400/40 bg-blue-500/10 px-3 py-1.5 text-[12px] font-semibold text-blue-600 hover:bg-blue-500/20 dark:text-blue-200"
        >
          관리
        </button>
      </div>
