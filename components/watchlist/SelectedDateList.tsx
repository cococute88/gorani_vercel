...
import CalendarEventList, { type TaxSavingByTicker } from "./CalendarEventList";
...
export default function SelectedDateList({ selectedDate, events, todayIso, onOpenEvent, taxSavingByTicker, tickerMemos }: Props) {
  return (
    <CalendarEventList
