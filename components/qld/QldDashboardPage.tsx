...
export default function QldDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 dark:bg-[#06070b] dark:text-slate-200">
      <TopNav theme={theme} />
      <main className="mx-auto max-w-[1840px] px-5 py-6 lg:px-8">
        <div className="mb-5 flex flex-wrap items-end justify-between gap-2">
          <div>
            <h1 className="text-[20px] font-extrabold text-slate-900 dark:text-white">QLD 대시보드</h1>
        ...
        <section className="mb-4 rounded-[18px] border border-slate-200 bg-white p-5 dark:border-[#242938] dark:bg-[#12151e]">
          <div className="text-[14px] font-bold text-slate-900 dark:text-slate-100">QLD 전용 콘텐츠</div>
